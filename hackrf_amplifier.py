...
class hackrf_amplifier(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "HackRF Amplifier Control", catch_exceptions=True)
        ...
        self.top_layout.addWidget(_rf_gain_check_box)
        ...
        self._freq_range = Range(2.4e9, 2.5e9, .1e9, 2.45e9, 200)
